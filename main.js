...
//Get user location to use in places fetch
...
const full = navigator.geolocation.getCurrentPosition(showPosition);

//Fetch places

function locationFill(){
  let url = "https://api.foursquare.com/v2/venues/search?client_id="+CLIENT_ID+"&client_secret="+CLIENT_SECRET+"&v=20180323&ll="+lati+","+long+"&radius=100000&categoryId=4d4b7105d754a06374d81259"
  $.ajax({
    dataType: "json",
    url: url,
    data: {},
